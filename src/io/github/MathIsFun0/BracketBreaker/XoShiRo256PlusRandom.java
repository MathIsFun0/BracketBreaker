...
//Source: https://github.com/vigna/dsiutils/tree/master/src/it/unimi/dsi/util
...
public class XoShiRo256PlusRandom extends Random {
    ...
    /** Creates a new generator seeded using randomSeed(). */
    public XoShiRo256PlusRandom() {
        this(randomSeed());
    }

    private static final XoShiRo256PlusRandom seedUniquifier = new XoShiRo256PlusRandom(System.nanoTime());

    /** Returns a random seed generated by taking the output of this
     ...
     *
     * <p>The argument will be used to seed a Random generator, whose output
